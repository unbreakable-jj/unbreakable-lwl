...
export type Exercise = 
  | 'bench' | 'incline_bench' | 'squat' | 'sumo_squat' 
  | 'deadlift' | 'sumo_deadlift' | 'ohp' | 'db_chest_press' 
  | 'incline_db_chest_press' | 'leg_press' | 'bent_over_row'
...
const strengthStandards: Record<Exercise, Record<Gender, number[]>> = {
  ...
  incline_db_chest_press: {
    male: [0.15, 0.3, 0.45, 0.6, 0.75],
    female: [0.08, 0.18, 0.28, 0.4, 0.55],
  },
  leg_press: {
  ...
  db_shoulder_press: {
    male: [0.15, 0.25, 0.4, 0.55, 0.7],
    female: [0.08, 0.15, 0.25, 0.35, 0.5],
  },
  barbell_curl: {
    male: [0.25, 0.4, 0.55, 0.7, 0.9],
    female: [0.15, 0.25, 0.35, 0.5, 0.65],
  },
  db_curl: {
    male: [0.1, 0.18, 0.28, 0.38, 0.5],
    female: [0.05, 0.1, 0.18, 0.28, 0.38],
  },
  tricep_dips: {
  ...
  chin_up: {
    ...
    female: [0.35, 0.55, 0.8, 1.1, 1.4],
  },
  press_up: {
    male: [0.4, 0.55, 0.7, 0.85, 1.0],
    female: [0.25, 0.4, 0.55, 0.7, 0.85],
  },
};
