...
export const level2Unit2Assessment: UnitAssessment = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: ['Carbohydrates', 'Fats', 'Protein', 'Alcohol'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['Glucose', 'Glycogen', 'Fructose', 'Sucrose'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        ...
        'They have depleted their glycogen stores due to insufficient carbohydrate intake',
        'They need to take a multivitamin supplement',
      ],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['Calcium', 'Zinc', 'Magnesium', 'Iron'],
      correctAnswer: 3,
    ...
    // ─── CHAPTER 3: Hydration & Fluid Balance (6 questions) ───
    {
      ...
      options: ['0.5% body weight loss', '1-2% body weight loss', '3-5% body weight loss', '10% body weight loss'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['Dehydration', 'Over-hydration', 'Adequate hydration', 'Kidney problems'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['15ml per kg', '25ml per kg', '35ml per kg', '50ml per kg'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [
        ...
        'They have a food intolerance',
        'Their training programme is too intense',
      ],
      correctAnswer: 1,
    ...
    // ─── CHAPTER 4: Energy Balance & Body Composition (6 questions) ───
    {
      ...
      options: ['Exercise Activity Thermogenesis (EAT)', 'Non-Exercise Activity Thermogenesis (NEAT)', 'Basal Metabolic Rate (BMR)', 'Thermic Effect of Food (TEF)'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['5-10%', '10-20%', '30-50%', '60-80%'],
      correctAnswer: 2,
    ...
    // ─── CHAPTER 5: Reading Food Labels (6 questions) ───
    {
      ...
      options: ['Per serving', 'Per 100g', 'Per pack', 'Reference Intake percentage'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['More than 5g', 'More than 10g', 'More than 22.5g', 'More than 30g'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['Maltodextrin', 'Dextrose', 'Cellulose', 'High-fructose corn syrup'],
      correctAnswer: 2,
    ...
    // ─── CHAPTER 6: Nutrient Timing & Meal Structure (6 questions) ───
    {
      ...
      options: ['5-10 minutes before', '30-60 minutes before (snack) or 2-3 hours before (full meal)', 'Immediately before entering the gym', 'The evening before'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['Exactly 30 minutes', '30-60 minutes only', 'Several hours (unless training fasted)', 'It does not exist at all'],
      correctAnswer: 2,
